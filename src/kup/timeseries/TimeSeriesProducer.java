...
public interface TimeSeriesProducer {
	...
	public TimeSeries compute(String name)  throws TimeSeriesException, CrossSampleException;
	public TimeSeries compute()  throws TimeSeriesException, CrossSampleException;
}
