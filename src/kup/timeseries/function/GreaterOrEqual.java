...
public final class GreaterOrEqual extends OperationBase implements Operation {

	public GreaterOrEqual(TimeSeries input1, TimeSeries input2) {
		setInputs(input1, input2);
	}

	DataPoint computeNext(DataPoint in1, DataPoint in2) {
		return new DataPoint(in1.date(), in1.value() >= in2.value() ? 1.0f : 0.0f);
	}
}
