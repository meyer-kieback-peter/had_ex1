...
public final class Mult extends OperationBase implements Operation {

	public Mult(TimeSeries input1, TimeSeries input2) {
		setInputs(input1, input2);
	}

	DataPoint computeNext(DataPoint in1, DataPoint in2) {
		return new DataPoint(in1.date(), in1.value() * in2.value());
	}
}
