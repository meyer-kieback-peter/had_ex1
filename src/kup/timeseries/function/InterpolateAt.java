...
public final class InterpolateAt extends OperationBase implements Operation {

	public InterpolateAt(TimeSeries input1, TimeSeries input2) {
	...
	public TimeSeries compute(String name) {
		...
		for (int i = 0; i< input2.size(); i++) {
			DataPoint dp = input2.getDataPoint(i);
			try {
				ret.addDataPoint(input1.interpolate(dp.date()));
