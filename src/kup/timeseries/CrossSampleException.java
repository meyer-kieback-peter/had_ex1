...
public class CrossSampleException extends Exception {

	private static final long serialVersionUID = -1152562114738394673L;

	public CrossSampleException() {
	}

	public CrossSampleException(String message) {
		super(message);
	}

	public CrossSampleException(Throwable cause) {
		super(cause);
	}

	public CrossSampleException(String message, Throwable cause) {
		super(message, cause);
	}

	public CrossSampleException(String message, Throwable cause, boolean enableSuppression,
