...
public class TimeSeriesException extends Exception {
	...
	private static final long serialVersionUID = -8116887949287945956L;
	...
	public TimeSeriesException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
